...
public interface IFileStorageService
{
    ...
    /// </returns>
    Task<string> SaveAsync(IFormFile file, string folder, FileAccessLevel accessLevel,
    ...
    /// Серверне ім'я файлу без розширення.
    /// </returns>
    Task<string> ReplaceAsync(IFormFile file, string folder, string fileName, FileAccessLevel accessLevel,
        CancellationToken cancellationToken = default);
    ...
    /// Токен скасування операції.
    /// </param>
    Task DeleteAsync(string folder, string fileName, FileAccessLevel accessLevel,
        CancellationToken cancellationToken = default);
    ...
    /// </returns>
    FileDownloadResult? OpenRead(string folder, string fileName, FileAccessLevel accessLevel);
}